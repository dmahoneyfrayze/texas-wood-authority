...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const post = getPostBySlug("process", slug);
                    ...
                    <article className="max-w-3xl">
                        <Breadcrumbs
                            items={[
                                ...
                                { label: frontmatter.title, href: `/process/${post.slug}` },
                            ]}
                        />
                        ...
                        <div className="mb-8 border-b border-stone-200 pb-8 dark:border-stone-800">
                            <Link href="/process" className="text-sm font-medium text-stone-500 hover:text-stone-900 mb-6 inline-block transition-colors">
                                ← Back to Process
                            </Link>
                            <span className="block mb-4 text-sm font-semibold tracking-wider text-orange-700 uppercase">
                                Fabrication
                            </span>
                        ...
                        <div className="prose prose-stone prose-lg dark:prose-invert max-w-none prose-headings:font-[family-name:var(--font-outfit)] prose-a:text-orange-700 hover:prose-a:text-orange-800">
